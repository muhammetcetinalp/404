...
import { faSearch, faFilter, faUtensils, faPlus, faEdit, faTrash, faSave, faTimes, faSort } from '@fortawesome/free-solid-svg-icons';
import { faArrowDownAZ, faArrowDownZA, faArrowDown, faArrowUp } from '@fortawesome/free-solid-svg-icons';
                                ...
                                <div className="bg-white p-4 dashboard-sidebar" style={{ minHeight: "300px" }}>
                                    ...
                                    <div className="ml-2 mb-4">
                                        <div className="list-group">
                                            ...
                                            >
                                                <FontAwesomeIcon icon={faArrowDownZA} className="me-2" />
